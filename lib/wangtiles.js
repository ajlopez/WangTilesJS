    ...
    this.drawTiles = function () {
        ...
        for (var x = 0; x < width; x++)
            for (var y = 0; y < height; y++) {
                ...
                fillWest(image.data, image.width, x * cellsize, (height - y - 1) * cellsize, cellsize, getColor(tile.west()));
                fillSouth(image.data, image.width, x * cellsize, (height - y - 1) * cellsize, cellsize, getColor(tile.south()));
            }
    }
}
